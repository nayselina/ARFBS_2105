...
public class RoundedPlaceholderTextField extends JTextField {
    ...
    public RoundedPlaceholderTextField(String placeholder, int cornerRadius, Color borderColor) {
    ...
    public void setBorder(javax.swing.border.Border border) {
        // Override to remove the default border (so that our rounded corners can be used)
    }
